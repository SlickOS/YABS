...
g++-6 $INCLUDES $FLAGS -o Build/Objects/contrib/graphbuilder.cpp.o -c src/contrib/graphbuilder.cpp
...
g++-6 $INCLUDES $FLAGS -o Build/Objects/contrib/graphbuilderadapter.cpp.o -c src/contrib/graphbuilderadapter.cpp
echo Compiling src/binary.cpp  to  Build/Objects/binary.cpp.o
